...
//         .add(android.R.id.content, new FragmentLanguage ()).commit()
        ...
        binding.llTerms.setOnClickListener(view -> navigateToAppActivity("terms"));
        binding.llPrivacy.setOnClickListener(view -> navigateToAppActivity("privacy"));
    ...
    private void navigateToAppActivity(String type) {
