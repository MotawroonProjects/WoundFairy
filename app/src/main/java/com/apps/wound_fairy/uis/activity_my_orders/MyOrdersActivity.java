package com.apps.wound_fairy.uis.activity_my_orders;
...
import com.apps.wound_fairy.databinding.ActivityMyOrdersBinding;
...
public class MyOrdersActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        setUpToolbar(binding.toolbar, getString(R.string.my_orders), R.color.white, R.color.black);
